...
<head>
    ...
    <title>View Survey Result</title>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link">View Survey Result </a>
            </li>
        </ul>
...
<div class="container cardHolder">
    <h2 class="strokeme display-5 text-center text-warning font-weight-bold">View Survey Result</h2>
                        ...
                        <div class="listHolder{$question->order|escape:"html"}">
                            <div class="form-group">
                                <label class="display-4"
                                       for="question"><b>{$question->question_content|escape:"html"}</b></label>
                            </div>
                            <ul class="list{$question->order|escape:"html"}">
                                {if $question->question_type eq 0}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div id="piechart{$index}" style="width: 500px; height: 300px;"></div>
                                        </div>
                                    </div>
                                {else}
                                    <input type="hidden" value="{$question->id|escape:"html"}"
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        const data_chart_list = {/literal}{$chart}{literal};
        let index = 1;
        for (const data_chart of data_chart_list) {
